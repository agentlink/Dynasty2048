...
#define kTheme     NSLocalizedString(@"Theme", @"Theme")
#define kBoardSize NSLocalizedString(@"Board Size", @"Board Size")
...
{
  CGFloat height = self.dimension * (self.tileSize + self.borderWidth) + self.borderWidth + 70;
